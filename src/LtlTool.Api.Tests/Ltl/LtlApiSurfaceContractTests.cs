    ...
    : IClassFixture<TemplateWebApplicationFactory>
{
    ...
    [InlineData("/api/ltl/reporting/accessorials")]
    [InlineData("/api/ltl/reporting/accessorials/export")]
    [InlineData("/api/ltl/reporting/assignments-history")]
    [InlineData("/api/ltl/reporting/assignments-history/export")]
